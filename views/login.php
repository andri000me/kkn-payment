...
<head>
    ...
    <!-- Favicons -->
    <link href="<?= base_url(); ?>assets/img/nokencode.png" rel="icon">
...
<body class="hold-transition login-page">
    <div class="login-box">
        <div class="login-logo">
            <b><?=settings('general','app_name');?></b>
            <p style="font-size:10pt;"><?=settings('general','tagline');?></p>
        </div>
        <!-- /.login-logo -->
        ...
        <a href="<?=base_url('dashboard');?>" class="btn btn-info btn-xs btn-block btn-flat">Back To Website</a>
        <!-- /.login-box-body -->
    </div>
    <!-- /.login-box -->
