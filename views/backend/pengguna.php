...
function submit(x) {
    if (x == 'add') {
        ...
        $.ajax({
            ...
            url: '<?=base_url();?>settings/viewUser',
            dataType: 'json',
...
function ubahuser() {
    ...
    $.ajax({
        ...
        url: '<?=base_url();?>settings/updateUser',
        success: function() {
            $('#modal_add').modal('hide');
            toastr.success("Update Successfully");
            setTimeout(() => {
                window.location =
                    "<?=site_url();?>settings/pengguna";
            }, 2500);
        }
    });
}
...
function ubah_password(x) {
    ...
    if (x == 'ganti') {
        var action = '<?= base_url(); ?>settings/changepassword';
...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <a href="<?=base_url('settings/pengguna');?>" class="btn btn-sm btn-primary btn-flat" data-toggle="tooltip"
            ...
            <table id="datatable" class="table table-bordered table-striped table-hover">
                ...
                <tbody>
                    ...
                    <tr <?php if($u->is_block==1){ echo 'style="color:red;text-decoration:line-through;"';}?>>
                        ...
                        <td><a href="#ganti_password" data-toggle="modal" onclick="ubah_password(<?=$u->idusers;?>)"><i
                                    class="fa fa-key"></i></a>
                        </td>
...
<div class="modal fade" id="modal_add" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="<?=base_url('settings/addNewUser');?>" method="post" enctype="multipart/form-data">
